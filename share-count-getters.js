...
function getFacebookShareCount(shareUrl, callback) {
  var fql = encodeURIComponent('select like_count, share_count from ' + ('link_stat where url = \'' + String(encodeURIComponent(shareUrl)) + '\''));

  var endpoint = 'https://api.facebook.com/method/fql.query' + ('?format=json&query=' + String(fql));
